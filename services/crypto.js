...
// }
//https://api.polygon.io/v1/last/crypto/BTC/USD?apiKey=1ipWpOtJ0MyGTnMppG9sLWdW6mCxdtwe
...
const getOneCryptoEndpoint = (exchange) => {
  return `https://api.polygon.io/v2/snapshot/locale/global/markets/crypto/tickers/${exchange}?apiKey=${process.env.STOCKS_API_KEY}`
}
...
const getOneCryptoExchangeRate = (string) => {
  console.log(getOneCryptoEndpoint(string));
  return axios.get(getOneCryptoEndpoint(string))
}
